...
Once the VM is created and the root password changed please
jump to the section `Configuration and reconfiguration`.
...
* Connect as (root) via SSH or the console.
