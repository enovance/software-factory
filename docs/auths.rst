...
through the SFManager command-line utility (except for the default admin user, defined in the sfconfig.yaml file).
You can read SFmanager command-line documentation :ref:`User management <user-management>`.
