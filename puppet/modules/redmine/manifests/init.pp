...
class redmine {
    ...
    exec {'set_url_root':
      command => "sed -i '/^.*::relative_url_root =.*/d' /var/www/redmine/config/environment.rb && echo 'Redmine::Utils::relative_url_root = \"/redmine\"' >> /var/www/redmine/config/environment.rb",
