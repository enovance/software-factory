...
To change the Redmine API key, you need to edit /etc/software-factory/custom-vars.yaml and change the value of
`redmine_api_key`. Then call `sfconfig.sh` to update the key.
