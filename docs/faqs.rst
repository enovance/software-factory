...
Once a mirror is enabled, it will be automatically replicated to swift by
the config-update job. And when the periodic_update is set,
the mirror update will be scheduled periodically.
