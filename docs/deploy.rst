...
Note that SF will use "tests.com" as default FQDN and if the FQDN doesn't resolve it needs to be locally
...
with "tests.com" as the FQDN and "admin/userpass" as admin credentials.
...
using "Internal Login". If you used the default domain *tests.com* then
