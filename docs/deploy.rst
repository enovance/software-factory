...
By default this is *userpass*.  Use the following code to compute a new
password:

.. code-block:: bash

 $ python -c 'import hashlib, uuid; s = uuid.uuid4().hex; print s + "#" + hashlib.sha512("new_password" + s).hexdigest()'
