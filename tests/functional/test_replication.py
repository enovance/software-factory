...
class TestProjectReplication(Base):
    ...
    def setUp(self):
        ...
        self.m_repo_path = "ssh://%s@%s/%s" % (
            config.GERRIT_USER, config.GATEWAY_HOST, 'home/gerrit/git/')
    ...
    def test_replication(self):
        ...
        m_repo_url = self.m_repo_path + '%s.git' % self.pname
        self.mirror_clone_and_check_files(m_repo_url, self.pname, us_files)
