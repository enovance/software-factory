...
function prepare_functional_tests_venv {
    ...
    (
        ...
        # pysflib + python-sfmanager requirements
        pip install --upgrade 'setuptools' 'pbr' 'pycrypto' 'pycrypto==2.6.1' 'urllib3==1.11' 'python-redmine==1.2.0'       \
                              'pyyaml==3.11' 'six==1.10.0' '-e git+https://github.com/morucci/pygerrit.git#egg=pygerrit'    \
                              'nose'
