...
class commonservices-apache {
  ...
  file {'/var/www/css/font-awesome.min.css':
    ensure => file,
    mode   => '0640',
    owner  => $httpd_user,
    group  => $httpd_user,
  ...
  file {'/var/www/login.html':
    ensure => file,
    mode   => '0640',
    owner  => $httpd_user,
    group  => $httpd_user,
    content => template('commonservices-apache/login.html'),
  }

  file {'/var/www/fonts/FontAwesome.otf':
    ensure => file,
    mode   => '0640',
    owner  => $httpd_user,
    group  => $httpd_user,
    source  => 'puppet:///modules/commonservices-apache/fonts/FontAwesome.otf',
    require => File['/var/www/fonts'],
  }

  file {'/var/www/fonts/fontawesome-webfont.eot':
    ensure => file,
    mode   => '0640',
    owner  => $httpd_user,
    group  => $httpd_user,
  ...
  file {'/var/www/fonts/fontawesome-webfont.svg':
    ensure => file,
    mode   => '0640',
    owner  => $httpd_user,
    group  => $httpd_user,
  ...
  file {'/var/www/fonts/fontawesome-webfont.ttf':
    ensure => file,
    mode   => '0640',
    owner  => $httpd_user,
    group  => $httpd_user,
  ...
  file {'/var/www/fonts/fontawesome-webfont.woff':
    ensure => file,
    mode   => '0640',
    owner  => $httpd_user,
    group  => $httpd_user,
