...
class commonservices_apache ($cauth = hiera_hash('cauth', '')) {
  ...
  file {'gateway_common':
    ...
    owner   => $::httpd_user,
    group   => $::httpd_user,
    content => template('commonservices-apache/gateway.common.erb'),
  }
  ...
  file {'gateway_conf':
    ...
    owner   => $::httpd_user,
    group   => $::httpd_user,
    content => template('commonservices-apache/gateway.conf.erb'),
  ...
  file {'/var/www/topmenu.html':
    ...
    owner   => $::httpd_user,
    group   => $::httpd_user,
    content => template('commonservices-apache/topmenu.html.erb'),
  }
