...
You can use _`sfstack` to quickly get a development environment and your Software Factory up and running.
...
you to run functional and unit tests
 ...
 * Insert 'from nose.tools import set_trace; set_trace()' to add breakpoint in nosetests
