...
function run_gui_tests {
    ...
    command -v ffmpeg > /dev/null && tmux new-session -d -s guiTestRecording 'ffmpeg -f x11grab -video_size 1280x1024 -i 127.0.0.1:99 -codec:v libtheora -qscale:v 9 -r 12 /tmp/gui/guiTests.ogv'
