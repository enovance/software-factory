...
Finally you need to activate the external_gerrit setting in sfconfig.yaml:
...
also need to configure the config repository to enable external_gerrit trigger.
...
.. code-block:: yaml
    ...
    pipelines:
        - name: 3rd-party-check
          ...
          source: external_gerrit
          trigger:
              external_gerrit:
                  - event: patchset-created


Notice the source and trigger are called 'external_gerrit' instead of the
default 'gerrit' name.
