...
class TestAdministratorTasks(BaseGuiTest):
    ...
    def test_add_user_to_project(self):
        ...
        with caption(self.driver, msg) as driver:
            ...
            driver.highlight_by_xpath(mgmt_btn_xpath % test_project).click()
        ...
        with caption(self.driver, msg) as driver:
            user_found = (".//*[@id='modal_create_members']/div/div/"
                          "form/div[1]/table/tbody/tr[td='%s']")
            self.highlight_by_xpath(user_found % config.USER_2)

        msg = ("Let's add the user as a Core Developer and submit.")
        with caption(self.driver, msg) as driver:
            core_btn = (".//*[@id='modal_create_members']/div/div/"
                        "form/div[1]/table/tbody/tr[td='%s']/td[3]/input")
