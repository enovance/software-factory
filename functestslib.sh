...
function run_upgrade {
    ...
    [ "$review_id" != "0" ] && {
        ssh sftests.com "cd config; submit_and_wait.py --review-id $review_id --recheck --approve"
    ...
    [ "$review_id" != "0" ] && {
        ssh sftests.com "cd config; submit_and_wait.py --review-id $review_id --rebase --approve"
