...
.. code-block:: bash
 ...
 $ gpg --verify softwarefactory-C7.0-2.2.1.digest && sha256sum -c softwarefactory-C7.0-2.2.1.digest
...
.. code-block:: bash
 ...
 $ wget http://46.231.133.241:8080/v1/AUTH_sf/sf-images/softwarefactory-C7.0-2.2.1.img.qcow2
 $ glance image-create --progress --disk-format qcow2 --container-format bare --name sf-2.2.1 --file softwarefactory-C7.0-2.2.1.img.qcow2
...
.. code-block:: bash
 ...
 $ wget http://46.231.133.241:8080/v1/AUTH_sf/sf-images/softwarefactory-C7.0-2.2.1-allinone.hot
 $ heat stack-create --template-file ./softwarefactory-C7.0-2.2.1-allinone.hot -P "key_name=SSH_KEY;domain=fqdn_of_deployment;image_id=GLANCE_UUID;ext_net_uuid=NETWORK_UUID;flavor=m1.large" sf_stack
...
2.2.1::
 ...
 curl -O http://46.231.133.241:8080/v1/AUTH_sf/sf-images/softwarefactory-C7.0-2.2.1.img.qcow2
...
database and convert the image to make it usable with Virtualbox::
 ...
 qemu-img resize softwarefactory-C7.0-2.2.1.img.qcow2 +20G
 qemu-img convert -O vdi softwarefactory-C7.0-2.2.1.img.qcow2 softwarefactory-C7.0-2.2.1.vdi
