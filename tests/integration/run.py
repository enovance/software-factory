...
def main():
    ...
    cmd = "ansible-playbook -i inventory %s.yaml" % pbname
    ...
    if pbname == "nodepool" and "SF_VER" not in os.environ:
        fail("Nodepool test need to need image version SF_VER environment")
