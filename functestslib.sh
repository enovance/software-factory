...
function build_image {
    ...
    if [ -z "${SKIP_BUILD}" ]; then
        ...
        sudo rsync -a --delete ${MANAGESF_CLONED_PATH}/managesf/ ${IMAGE_PATH}/srv/venv/lib/python2.7/site-packages/managesf/
        sudo rsync -a --delete ${CAUTH_CLONED_PATH}/cauth/ ${IMAGE_PATH}/srv/venv/lib/python2.7/site-packages/cauth/
        sudo rsync -a --delete ${PYSFLIB_CLONED_PATH}/pysflib/ ${IMAGE_PATH}/srv/venv/lib/python2.7/site-packages/pysflib/
        sudo rsync -a --delete ${SFMANAGER_CLONED_PATH}/sfmanager/ ${IMAGE_PATH}/srv/venv/lib/python2.7/site-packages/sfmanager/
