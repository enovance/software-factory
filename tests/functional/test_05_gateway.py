...
class TestGateway(Base):
    ...
    def test_topmenu_links_shown(self):
        ...
        url = "http://%s/topmenu.html" % config.GATEWAY_HOST
    ...
    def test_gerrit_accessible(self):
        ...
        urls = ["http://%s/r/" % config.GATEWAY_HOST,
                "http://%s/r/#/" % config.GATEWAY_HOST]
        ...
        url = "http://%s/r/a/projects/?" % config.GATEWAY_HOST
        resp = requests.get(url)
        self.assertEqual(resp.status_code, 200)
    ...
    def test_gerrit_api_accessible(self):
        ...
        url = "http://%s/api/" % config.GATEWAY_HOST
    ...
    def test_dashboard_accessible(self):
        ...
        """
        url = "http://%s/dashboard/" % config.GATEWAY_HOST
