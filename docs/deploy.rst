...
Bootstrap scripts will used the tagged version too.
...
You should find four qcow2 images: (install-server-vm, and softwarefactory).
...
The above command should have created three directories (install-server-vm, softwarefactory)
