...
def update_sfconfig(data):
    ...
    if data['authentication']['github']:
        data['authentication']['oauth2']['github']['disabled'] = data['authentication']['github']['disabled']
        data['authentication']['oauth2']['github']['client_id'] = data['authentication']['github']['github_app_id']
        data['authentication']['oauth2']['github']['client_secret'] = data['authentication']['github']['github_app_secret']
        data['authentication']['oauth2']['github']['github_allowed_organizations'] = data['authentication']['github']['github_allowed_organizations']
        del data['authentication']['github']
        dirty = True
    if data['authentication']['launchpad']:
        data['authentication']['oauth2']['disabled'] = data['authentication']['launchpad']['disabled']
