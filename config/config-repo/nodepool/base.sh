...
sudo pip install install zuul gitdb requests glob2 python-magic argparse tox bash8 flake8 ansible Sphinx \
    oslosphinx virtualenv restructuredtext_lint python-swiftclient python-keystoneclient
